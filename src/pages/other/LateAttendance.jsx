...
class AllocationsList extends Component {
  ...
  LateAttendanceReport = () => {
    ...
    LateAttendanceReport(requestData)
      .then((response) => {
        // resetForm();
      ...
      <div className="emp">
        ...
        <Card>
          <CardBody className="border-bottom p-2">
            <CardTitle>Late Attendance</CardTitle>
                  ...
                  <Table bordered size="sm" className="main-tbl-style">
                    ...
                    >
                      <tr>
                        ...
                        {/* {console.log("tt->",this.hasEmployeeNameKey(allocationData))}
                      {console.log("tt->",this.hasEmployeeNameKey(allocationData))} */}
                        ...
                        <th className="th-style">Late By</th>
                        <th className="th-style">Total Time</th>
                        {/* <th className="th-style">Actual Working Hours in Minutes</th> */}
                      </tr>
                    </thead>
                    {isLoading ? (
                      <tbody
                            ...
                            return (
                              <>
                                <tr>
                                  ...
                                  <td>
                                    {v.checkOutTime == "" ? "" : moment(v.checkOutTime).format("HH:mm:ss")}
                                  </td>
                                  <td>{v.lateTime}</td>
                                  <td>{v.totalTime}</td>
                                </tr>
