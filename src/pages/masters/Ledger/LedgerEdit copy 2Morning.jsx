...
class LedgerEdit extends React.Component {
        ...
        if (data.responseStatus == 200) {
          ...
          if (data.ledger_form_parameter_slug == "assets") {
            ...
            if (data.licensesDetails.length > 0) {
              console.log("data---->", data.licensesDetails);
              ...
              if (data.gstdetails.length > 0) {
                gstdetails = data.gstdetails.map((v, i) => {
                  return {
                    ...
                    registraion_type:
                      v.registration_type != ""
                        ? getSelectValue(GSTTypeOpt, v.registration_type)
                        : "",
            ...
            if (data.licensesDetails.length > 0) {
              licensesDetails = data.licensesDetails.map((v, i) => {
                return {
                  id: v.id,
                  // licences_type: getSelectValue(licencesType,v.licences_type),
                  licencesType: v.licencesType.slug_name,
                  licenses_num: v.licenses_num,
                  licenses_exp:
                    v.licenses_exp != "NA" && v.licenses_exp
                      ? moment(v.licenses_exp).format("DD/MM/YYYY")
  ...
  removeLicensesRow = (index) => {
    ...
    this.setState(
      ...
      () => {
        console.log("licensesList removed---->", this.state.removelicensesList);
        if (this.myRef.current) {
          this.myRef.current.setFieldValue("index", -1);
          this.myRef.current.setFieldValue("bid", "");
        }
              ...
              MyNotifications.fire(
                {
                  ...
                  handleSuccessFn: () => {
                    ...
                    if (
                      ...
                      if (values.isCredit != null && values.isCredit != "") {
                      ...
                      gstdetails = gstList.map((v, i) => {
                        ...
                        if (
                          ...
                          obj["registration_type"] = v.registraion_type.value;
                        }
                        if (
                      ...
                      licensesRemovedlist = removelicensesList.map((v) => v.id);
                      console.log(
                        "Licenses Removed---->",
                        licensesRemovedlist,
                        removelicensesList
                      ...
                      if (values.isDepartment != null) {
                        formData.append("isDepartment", values.isDepartment);
                      } else {
                    ...
                    if (
                      ...
                      gstdetails = gstList.map((v, i) => {
                        ...
                        obj["gstin"] = v.gstin;
                        if (
                          v.registration_type != null &&
                          v.registration_type != ""
                        ) {
                          obj["registration_type"] = v.registration_type.value;
                        }
                        if (
                          v.dateofregistartion != "" &&
                          v.dateofregistartion != null
                      ...
                      if (values.isBankDetails != null) {
                        formData.append("isBankDetails", values.isBankDetails);
                      } else {
                          ...
                          <Col lg={6}>
                            <Card className="bottom_card_style">
                              ...
                              <Card.Body>
                                ...
                                {/* {JSON.stringify(getSelectValue(stateOpt,4006).label)} */}
