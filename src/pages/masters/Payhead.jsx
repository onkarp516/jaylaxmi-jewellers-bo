    ...
    const columns = [
      ...
      },
      {
        ...
        cellRenderer: ({ data }) => {
          return (
            <div className="nightshift">
              {/* {console.log(data.payheadStatus)} */}
              <h1>{data.payheadStatus}</h1>
              <h4>
                <Badge
                  pill
                  style={{
                    backgroundColor:
                      data.payheadStatus == true ? "#A1C880" : "",
                  }}
                >
                  {data.payheadStatus == true ? "active" : "de-active"}
                </Badge>
              </h4>
              {/* {moment(data.createdAt).format("Do MMM YYYY")} */}
            </div>
          ...
          <Formik
            ...
            onSubmit={(values, { resetForm, setStatus, setSubmitting }) => {
              ...
              let requestData = {
                ...
                payheadStatus: values.payheadStatus,
              };
                  ...
                  <Row>
                    ...
                    <Col md="4">
                      <FormGroup check className="nightshiftlabel" inline>
                        <Label check>
                          <label className="p-2">Payhead status</label>
                          <Input
                            type="checkbox"
                            name="payheadStatus"
        ...
        >
          ...
          <Formik
            ...
            initialValues={{
              ...
              payheadStatus:
                payheadObject != null ? payheadObject.payheadStatus : "",
            }}
            validationSchema={Yup.object().shape({
                      ...
                      <FormGroup check className="nightshiftlabel" inline>
                        <Label check>
                          <Input
                            type="checkbox"
                            name="payheadStatus"
                            defaultChecked={values.payheadStatus === true}
                            onChange={handleChange}
                          />
                          &nbsp; &nbsp;
                        </Label>
