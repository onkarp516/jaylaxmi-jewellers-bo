...
class JournalList extends Component {
  ...
  render() {
    const { isLoading, initValue, journalList } = this.state;
      ...
      <div className="emp">
        <Card>
          <CardBody className="border-bottom p-2">
            ...
            >
              <CardTitle className="text-dark">Journal</CardTitle>
              <Row>
                <Col md="3">
                ...
                <Col md="9" style={{ textAlign: "end" }}>
                  <Button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      this.props.history.push(`/journal-create`);
                    }}
                  >
                    Create New
                  </Button>
...
export default WithUserPermission(JournalList);
