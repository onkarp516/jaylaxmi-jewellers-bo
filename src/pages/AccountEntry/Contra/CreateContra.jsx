...
class CreateContra extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="emp">
                <Card>
                    <CardBody className="border-bottom p-2">
                        {/* <CardTitle>Create Contra</CardTitle> */}
                            ...
                            <Formik
                                ...
                                onSubmit={(values, { setSubmitting, resetForm }) => {
                                    if (
                                        ...
                                        toast.error("Please match the Credit and debit Amount");
                                    }
                                }}
                                render={({
                                    errors,
...
export default WithUserPermission(CreateContra);
